...
SELECT
    ...
    NULL AS left_census_block_2000_basic,
    NULL AS left_census_block_2000_suffix,
    NULL AS right_census_block_2000_basic,
    NULL AS right_census_block_2000_suffix,
    NULL AS left_census_block_2010_basic,
    NULL AS left_census_block_2010_suffix,
    NULL AS right_census_block_2010_basic,
    NULL AS right_census_block_2010_suffix,
    centerline.snow_priority,
    centerline.bikelane_2,
    ...
    NULL AS left_census_tract_2020,
    NULL AS right_census_tract_2020,
    NULL AS left_census_block_2020_basic,
    NULL AS left_census_block_2020_suffix,
    NULL AS right_census_block_2020_basic,
    NULL AS right_census_block_2020_suffix,
FROM centerline
