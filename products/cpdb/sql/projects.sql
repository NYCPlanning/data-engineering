...
SELECT
    ...
    plannedcommit_ccnonexempt AS pccccnonex,
    plannedcommit_ccexempt AS pccccex,
    plannedcommit_citycost AS pcccc,
    plannedcommit_nccstate AS pccnccstate,
    plannedcommit_nccfederal AS pccnccfed,
    plannedcommit_nccother AS pccnccother,
    plannedcommit_noncitycost AS pccncc,
    plannedcommit_total AS pcctotal,
