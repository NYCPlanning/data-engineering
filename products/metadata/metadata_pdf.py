...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Convert a YAML file to a Markdown file.")
    parser.add_argument('yaml_file_path', type=str, help='The path to the input YAML file')
    parser.add_argument('pdf_file_path', type=str, help='The path to the output PDF file')
