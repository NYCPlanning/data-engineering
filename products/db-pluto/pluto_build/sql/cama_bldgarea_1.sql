...
UPDATE pluto a
SET
    comarea = (b.officearea::numeric + b.retailarea::numeric + b.garagearea::numeric + b.storagearea::numeric + b.factoryarea::numeric + b.otherarea::numeric),
    resarea = b.residarea,
