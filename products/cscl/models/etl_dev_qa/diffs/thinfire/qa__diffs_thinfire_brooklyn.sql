...
WITH base_diffs AS (
  {{ generate_diff_summary(
      old_relation=ref('qa_int__prod_thinfire_brooklyn'),
      new_relation=ref('thinfire_brooklyn_by_field'),
      primary_key='_thinfire_key',
      output_file_id='thinfire_brooklyn',
      build_table_name='thinfire_brooklyn_by_field',
      production_table_name='qa_int__prod_thinfire_brooklyn'
  ) }}
),
categorized AS (
    SELECT
