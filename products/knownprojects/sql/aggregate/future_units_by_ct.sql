...
future_units_with_ct AS (
    SELECT
        ...
        units_net,
        units_net_in_ct,
        future_phased_units_total_in_ct,
        future_units_without_phasing_in_ct,
        completed_units_in_ct,
...
future_units_by_ct AS (
    SELECT
        ...
        sum(future_phased_units_total_in_ct) AS future_phased_units_total,
        sum(future_units_without_phasing_in_ct) AS future_units_without_phasing,
        sum(completed_units_in_ct) AS completed_units,
