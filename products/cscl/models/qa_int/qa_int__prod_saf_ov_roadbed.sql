...
-- Add _saf_key to production SAF_OV_ROADBED output for QA comparison
...
{% set prod_relation = adapter.get_relation(
    ...
    identifier = "saf_ov_roadbed"
) -%}

SELECT
    *,
    -- Matches the extended key in saf_ov_roadbed_by_field.sql - see that model for
