...
future_units_with_cd AS (
    SELECT
        ...
        units_net,
        units_net_in_cd,
        future_phased_units_total_in_cd,
        future_units_without_phasing_in_cd,
        completed_units_in_cd,
...
future_units_by_cd AS (
    SELECT
        ...
        sum(future_phased_units_total_in_cd) AS future_phased_units_total,
        sum(future_units_without_phasing_in_cd) AS future_units_without_phasing,
        sum(completed_units_in_cd) AS completed_units,
