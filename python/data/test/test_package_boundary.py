...
def test_cannot_import_lifecycle():
    ...
    when run against an isolated sync (uv sync --package dcpy-data), which is the only
    context where dcpy.lifecycle is genuinely absent - see bash/run_isolated_tests.sh.
    """
