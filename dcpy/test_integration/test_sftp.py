...
def test_put_file(default_sftp_kwargs: dict):
    default_sftp_kwargs["local_file_path"] = RESOURCES_DIR / "sftp" / "a_local_file.txt"
    default_sftp_kwargs["server_file_path"] = "remote_files/a_new_file.txt"
    response = sftp.put_file(**default_sftp_kwargs)
