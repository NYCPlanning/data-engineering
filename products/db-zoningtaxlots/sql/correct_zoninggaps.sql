...
UPDATE dcp_zoning_taxlot
SET
    specialdistrict1 = specialdistrict2,
    specialdistrict2 = NULL
WHERE specialdistrict1 IS NULL;
UPDATE dcp_zoning_taxlot
SET
    specialdistrict2 = specialdistrict3,
