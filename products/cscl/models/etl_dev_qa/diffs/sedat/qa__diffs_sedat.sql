...
WITH base_diffs AS (
  {{ generate_diff_summary(
      old_relation=ref('qa_int__prod_sedat'),
      new_relation=ref('sedat_by_field'),
      primary_key='_sedat_key',
      output_file_id='sedat',
      build_table_name='sedat_by_field',
      production_table_name='qa_int__prod_sedat'
  ) }}
),
categorized AS (
    SELECT
