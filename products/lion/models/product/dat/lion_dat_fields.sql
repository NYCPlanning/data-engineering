...
SELECT
    ...
    format_lion_text(center_of_curvature_x::TEXT, 7, '0', TRUE) AS "Center of Curvature X-Coordinate",
    format_lion_text(center_of_curvature_y::TEXT, 7, '0', TRUE) AS "Center of Curvature Y-Coordinate",
