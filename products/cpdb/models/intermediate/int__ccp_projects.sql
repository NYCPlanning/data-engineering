...
SELECT
    ...
    CASE
        ...
        ELSE managing_agencies.managing_agency_acronym
    END AS magencyacro,
    CASE
        ...
        ELSE managing_agencies.managing_agency
    END AS magencyname
FROM projects
INNER JOIN descriptions ON projects.maprojid = descriptions.maprojid AND descriptions.rk = 1
INNER JOIN {{ ref('stg__dcp_managing_agencies_lookup') }} AS managing_agencies
    ON projects.magency = managing_agencies.agency_code
