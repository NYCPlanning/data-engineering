...
#### ABCEP Records
For inclusion in the backbone of all SAF segment-based records (`int__saf_segments`), all saf altsegmentdata records with saftype A, B, C, E, P are selected.
...
#### GNX Records
For inclusion in the backbone of all SAF segment-based records (`int__saf_segments`), select all commonplace records with 
- saftype G, N, or X
- non-blank/null b7sc
...
#### D Records
D records are generated from all saf altsegmentdata records with saftype 'D' or 'F'.
...
#### O Records
O records are generated from all saf altsegmentdata records with saftype 'O'.
...
#### V Records
V records are generated from all address point records with `special_condition` = 'V'.
