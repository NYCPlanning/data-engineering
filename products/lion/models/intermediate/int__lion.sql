...
SELECT
    ...
    CASE WHEN ap_left.segmentid IS NOT NULL THEN centerline.lsubsect END AS lsubsect,
    CASE
    ...
    CASE WHEN ap_right.segmentid IS NOT NULL THEN centerline.rsubsect END AS rsubsect,
    CASE
