...
run_sql_file analysis/projects_dollars_mapped_categorized_managing.sql
run_sql_file analysis/projects_dollars_mapped_categorized_sponsor.sql

# Planned commitments by community district
echo 'Creating reports by community district'
run_sql_file analysis/projects_by_communitydist.sql
run_sql_file analysis/projects_by_communitydist_spending.sql
run_sql_file analysis/projects_by_communitydist_spending_date.sql

# # Agency validated geoms summary table
echo 'Creating agency validated geoms summary table'
run_sql_file analysis/agency_validated_geoms_summary_table.sql

# Geospatial check 
echo 'Creating geospatial check table'
run_sql_file analysis/geospatial_check.sql -v ccp_v=$ccp_v 
