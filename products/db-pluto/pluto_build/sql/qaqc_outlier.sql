    ...
    FROM (
        SELECT
            jsonb_agg(json_build_object(
                'bbl', tmp.bbl, 'unitsres', tmp.unitsres, 'resarea', tmp.resarea,
        ...
        SELECT
            jsonb_agg(json_build_object(
                'bbl', tmp.bbl, 'bldgarea', tmp.bldgarea, 'lotarea', tmp.lotarea,
                'numfloors', tmp.numfloors, 'blog_lot_ratio', tmp.bldg_lot_ratio
