...
_DEFAULT_PRIVATE_BUCKET = "edm-private"
PRIVATE_BUCKET = env.get("PRIVATE_BUCKET", _DEFAULT_PRIVATE_BUCKET)
...
# Project root directory (assumes this file is at PROJECT_ROOT/python/utils/dcpy/configuration.py)
