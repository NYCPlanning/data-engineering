...
WITH base_diffs AS (
  {{ generate_diff_summary(
      old_relation=ref('qa_int__prod_saf_ov_roadbed'),
      new_relation=ref('saf_ov_roadbed_by_field'),
      primary_key='_saf_key',
      output_file_id='saf_ov_roadbed',
      build_table_name='saf_ov_roadbed_by_field',
      production_table_name='qa_int__prod_saf_ov_roadbed'
  ) }}
),
categorized AS (
    SELECT
