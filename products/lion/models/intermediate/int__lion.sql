...
SELECT
    ...
    CASE WHEN ap_left.segmentid IS NOT NULL THEN nullif(centerline.lsubsect, '0') END AS lsubsect,
    CASE
    ...
    CASE WHEN ap_right.segmentid IS NOT NULL THEN nullif(centerline.rsubsect, '0') END AS rsubsect,
    CASE
