    ...
    match format:
        ...
        case _:
            raise NotImplementedError(
                f"Export of dataset type {format} not implemented yet"
            )
...
def export(recipe_lock_path: Path) -> None:
    ...
    output_folder = Path(recipe.exports.folder)
    ...
    for output in recipe.exports.datasets:
        export_dataset_from_postgres(
            ...
            file_path=output_folder / output.filename,
            pg_client=pg_client,
            format=output.format,
        )

    if recipe.exports.zip:
        zip_path = output_folder / f"{recipe.exports.folder}.zip"
